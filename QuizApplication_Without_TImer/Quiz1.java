...
//        getContentPane().setBackground(Color.PINK);
        ...
        submit.addActionListener(e -> {
            ...
            if (groupOptions.getSelection() != null) {
                ...
                new QuizResult1(user, score, ans, useranswer);
//                System.out.println();
//                System.out.println("    ------------------------------------------");
//                System.out.println("               Quiz Answers Summary           ");
//                System.out.println("    ------------------------------------------");
//
//                System.out.println("\nQuiz Answers : ");
//                for (int i = 0; i < 10; i++) {
//                    for (int j = 0; j < 1; j++) {
//                        System.out.println("\t\t" + (i+1) + ". " + answers[i][j]);
//                    }
//                }
//                System.out.println("\nYour Answers : ");
//                for (int i = 0; i < 10; i++) {
//                    for (int j = 0; j < 1; j++) {
//                        if(answers[i][j].equals(userAns[i][j])) {
//                            System.out.println("\n\t\t" + (i + 1) + ". " + userAns[i][j] + " : Correct.");
//                        }
//                        else{
//                            System.out.println("\n\t\t" + (i + 1) + ". " + userAns[i][j] + " : Wrong." + " \n\t\t-> Correct-Ans : " + answers[i][j]);
//                        }
//                    }
//                }
            }
