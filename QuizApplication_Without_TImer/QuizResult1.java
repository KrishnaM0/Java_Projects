...
public class QuizResult1 extends JFrame {

    String[] check = new String[10];
    int height = 100;
    QuizResult1(String user, int score, String[] ans, String[] userans){
        setLayout(null);
        setVisible(true);
    ...
    public static void main(String[] args) {
        ...
        String[] ans = Quiz1.ansSummary();
        String[] userans = Quiz1.userans();
        new QuizResult1("user", 0, ans, userans);
    }
}
